...
public class PulseMcpChineseCrawler {
    ...
    // PulseMCP 的 v0beta/servers 端点已返回 410 Gone（官方下线），默认关闭该来源，避免无效请求与日志刷屏；
    // 如官方恢复或改用新端点，可通过 app.skill.crawler.cn-mcp.enabled=true 重新开启。
    @Value("${app.skill.crawler.cn-mcp.enabled:false}")
