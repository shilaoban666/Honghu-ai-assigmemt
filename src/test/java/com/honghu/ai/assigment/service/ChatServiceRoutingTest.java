...
class ChatServiceRoutingTest {
    ...
    @Mock
    private com.honghu.ai.assigment.skill.builtin.claude.SkillPromptResolver skillPromptResolver;
    @Mock
    ...
    void shouldRouteToComplexModelWhenComplexTaskKeywordMatched() {
        ...
        assertThat(routedModel).isEqualTo("deepseek-v4-pro");
    }
    ...
    void shouldKeepShortTextTaskOnSimpleModelWhenMatchedTypeIsText() {
        ...
        assertThat(routedModel).isEqualTo("deepseek-v4-flash");
    }
    ...
    void shouldSwitchToCloudFallbackWhenLocalModelUnavailable() {
        ...
        when(aiModelAccessService.resolveModelForChat(guest, null, "deepseek-v4-flash")).thenReturn(localModel);
        when(connectionHealthChecker.isOllamaAvailable()).thenReturn(false);
        when(aiModelAccessService.resolveFallbackModelWhenLocalUnavailable(guest, "deepseek-v4-flash")).thenReturn(fallbackModel);
